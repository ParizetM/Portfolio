    ...
    <section id="about" class="flex flex-col items-center justify-center py-8 antialiased md:py-16 section">
      <div class="text-center">
        ...
        <p class="max-w-2xl mx-auto text-gray-400 md:mb-12 md:text-lg mb-3 lg:mb-5 lg:text-xl p-6">
          ...
          Actuellement en BTS SIO SLAM à l'IIA Saint-Nazaire, je cherche à améliorer mes compétences et à participer à des projets suceptible de développer mes compétences. </p>
    ...
    <section id="competences" class="flex flex-col items-center justify-center py-8 antialiased md:py-16 section">
      ...
      <div class="max-w-4xl mx-auto w-full ">
        ...
        <div class="skill-container relative h-[600px] w-full rounded-xl p-4 mb-12">
          <?php
          // Directory for clickable technologies
          ...
          // Process clickable technologies
          ...
          // Process non-clickable technologies

          // echo "overlaps : ". $attempts;
          // echo "overlaps : ". $attempts;
